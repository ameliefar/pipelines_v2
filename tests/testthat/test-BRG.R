...
test_that("Location_data returns an expected outcome...", {
  ...
  expect_equal(loc_29$decimalLatitude, 60.2582)
  expect_equal(loc_29$decimalLongitude, 5.2835)
  ...
  expect_equal(loc_2$decimalLatitude, 60.3494)
  expect_equal(loc_2$decimalLongitude, 5.3337)
